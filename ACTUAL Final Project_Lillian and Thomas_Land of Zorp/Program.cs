...
while ((whatClass != "fighter") || (whatClass != "magic man"))
{
...
void UseAnItem(string myWeapon)
{
    if ((myWeapon == "sword") || (myWeapon == "tome"))
    {
        ...
        if (doesHaveTome == true)
        {
            ...
            {
                Console.WriteLine("You watch as the bugbear's fur goes up in flames, quickly turning the creature into a burnt husk");
                bugbearHealth = 0;
            }
...
while (adventureAwaits == true)
{
    ...
    else if ((goblinAppears == false) && (bugbearAppears == false) && (orcAppears == false) &&
             (whatClass == "magic man"))
    {
        Console.WriteLine(
            "The power of the arcane flows through you, and you feel as though you've grown beyond your previous potential");
        levelUp = true;
    }
    ...
    else if ((coordinateStateX == -2) && (coordinateStateY == 0))
    {
        if (orcAppears == true)
        {
            ...
            while (rollInitative == true)
            {
                ...
                if (fightCommand == "move")
                {
                    Console.WriteLine("you feel a pain in your back, as the world fades black around you. Coward");
    ...
    else if ((coordinateStateX == -2) && (coordinateStateY == 2))
    {
            ...
            while (rollInitative == true)
            {
                ...
                if (fightCommand == "move")
                {
                    ...
                    if ((fightCommand == "use") && (rollInitative == true))
                    {
                        ...
                        else if ((bossHealth == 0) && (whatClass == "fighter"))
                        {
                            Console.WriteLine(
                        ...
                        else if ((bossHealth == 0) && (whatClass == "magic man"))
                        {
                            Console.WriteLine(
                                "As the dragon gets incinerated, it crashes to the ground, shaking the cave with incradible force. The beast is dead");
                            bossDefeated = true;
                            rollInitative = false;
                            break;
                        }
        ...
        {
            Console.WriteLine(
                "The tome is a small book filled with aged yellow pages. There are three spells listed../");
        ...
        else if ((command == "use") && (rollInitative == false) && (additionalInfo == "tome") &&
                 (whatClass == "magic man"))
        {
