...
{
    Console.WriteLine("You are a learned magic man, armed with a small tome of spells. Remember the cost of failure!");
    doesHaveSword = false;
    doesHaveTome = true;
}
...
void UseAnItem(string myWeapon)
{
    if ((myWeapon == "sword") || (myWeapon == "tome"))
    {
        ...
        else if (doesHaveTome == true)
        {
            ...
            {
                Console.WriteLine(
                    "The orc finds himself frozen in place, now calm and serene. Unfortunately for an Orc that is generally too angry to die, the large beast soon collapses with a smile on its face.");
                orcHealth = 0;
            }
        ...
        {
            Console.WriteLine("You do not have anything to use, adventurer!");
        }
    }
...
while (adventureAwaits == true)
{
    ...
    {
        Console.WriteLine("I am afraid you cannot use this here, Adventurer."); 
    }
    ...
    else if ((coordinateStateX == -2) && (coordinateStateY == 0))
    {
        if (orcAppears == true)
        {
            ...
            while (rollInitative == true)
            {
                ...
                {
                    Console.WriteLine("You try to run away and fucking die. Get rekt loser.");
    ...
    if ((bossDefeated == true) && (rollInitative == false))
    {
